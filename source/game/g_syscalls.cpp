...
static void ClientCommand( edict_t *ent, uint64_t clientSideCounter, uint64_t serverSideCounter ) {
	ClientCommandsHandler::instance()->handleClientCommand( ent, clientSideCounter, serverSideCounter );
}
