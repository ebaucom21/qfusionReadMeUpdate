...
void G_Init( unsigned int seed, unsigned int framemsec, int protocol, const char *demoExtension ) {
	...
	g_rocket_gravity_scale = trap_Cvar_Get( "g_rocket_gravity_scale", "0.33", CVAR_DEVELOPER );
	g_plasma_gravity_scale = trap_Cvar_Get( "g_plasma_gravity_scale", "-0.67", CVAR_DEVELOPER );
