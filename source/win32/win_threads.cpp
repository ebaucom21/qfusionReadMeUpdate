...
void Sys_InitThreads( void ) {
	...
	if( kernel32Dll ) {
		pInitializeConditionVariable = ( decltype( pInitializeConditionVariable ) )( void * )GetProcAddress( kernel32Dll, "InitializeConditionVariable" );
		pWakeConditionVariable = ( decltype( pWakeConditionVariable ) )( void * )GetProcAddress( kernel32Dll, "WakeConditionVariable" );
		pSleepConditionVariableCS = ( decltype( pSleepConditionVariableCS ) )( void * )GetProcAddress( kernel32Dll, "SleepConditionVariableCS" );
	}
#endif
}
